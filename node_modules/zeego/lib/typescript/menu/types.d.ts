...
import type { ImageOptions, ImageSystemSymbolConfiguration } from 'react-native-ios-context-menu/src/types/ImageItemConfig';
...
export type MenuSubTriggerProps = Omit<MenuItemProps, keyof Pick<MenuItemProps, 'onSelect'>> & {
    key: string;
};
...
export type ContextMenuSubContentProps = ContextMenuContentProps & Pick<MenuContentProps, 'sideOffset'>;
