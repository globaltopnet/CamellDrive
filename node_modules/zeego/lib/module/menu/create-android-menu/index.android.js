...
<SubTrigger>
  ...
  2. OR, use the textValue prop on <${Menu}.Item textValue="Some value" />`);
      ...
      return Children.map(flattenChildren(children).map(item => {
        ...
        if (isInstanceOfComponent(_child, Item)) {
          ...
          if (item) {
            ...
            const menuState = child.props.value;
            const currentState = menuState === true ? 'on' : menuState === false ? 'off' : menuState;
            const hasItemIndicator = ((_pickChildren$targetC3 = pickChildren(child.props.children, ItemIndicator).targetChildren) === null || _pickChildren$targetC3 === void 0 ? void 0 : _pickChildren$targetC3[0]) !== undefined;
            let image = icon;
          ...
          const triggerItemChild = (_pickChildren$targetC4 = pickChildren(child.props.children, SubTrigger).targetChildren) === null || _pickChildren$targetC4 === void 0 ? void 0 : _pickChildren$targetC4[0];
          const triggerItem = triggerItemChild && getItemFromChild(triggerItemChild, index);

          if (triggerItem) {
            var _pickChildren$targetC5;

            const nestedContent = (_pickChildren$targetC5 = pickChildren(child.props.children, SubContent).targetChildren) === null || _pickChildren$targetC5 === void 0 ? void 0 : _pickChildren$targetC5[0];
    ...
    const label = (_pickChildren$targetC6 = pickChildren(content === null || content === void 0 ? void 0 : content.props.children, Label).targetChildren) === null || _pickChildren$targetC6 === void 0 ? void 0 : (_pickChildren$targetC7 = _pickChildren$targetC6[0]) === null || _pickChildren$targetC7 === void 0 ? void 0 : _pickChildren$targetC7.props.children;
    let menuTitle = '';
