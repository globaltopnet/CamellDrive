...
export declare class RNIDetachedView extends React.PureComponent<RNIDetachedViewProps, RNIDetachedViewState> {
    nativeRef?: View;
    reactTag?: number;
    ...
    getProps(): {
        ...
        contentTargetMode: import("./RNIDetachedViewContentTargetMode").RNIDetachedViewContentTargetMode;
        shouldApplyStyleOverride: boolean;
        shouldNotifyOnComponentWillUnmount: boolean;
        viewProps: {
            internalViewCleanupMode?: import("../..").RNIViewCleanupMode | undefined;
            onViewDidDetach?: OnDetachedViewDidDetachEvent | undefined;
