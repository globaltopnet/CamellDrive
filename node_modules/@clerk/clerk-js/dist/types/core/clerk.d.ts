import type { ActiveSessionResource, AuthenticateWithMetamaskParams, BeforeEmitCallback, Clerk as ClerkInterface, ClerkAPIError, ClerkOptions, ClientResource, CreateOrganizationParams, CreateOrganizationProps, DomainOrProxyUrl, EnvironmentJSON, EnvironmentResource, HandleEmailLinkVerificationParams, HandleMagicLinkVerificationParams, HandleOAuthCallbackParams, InstanceType, ListenerCallback, OneTapProps, OrganizationInvitationResource, OrganizationListProps, OrganizationMembershipResource, OrganizationProfileProps, OrganizationResource, OrganizationSwitcherProps, SDKMetadata, SetActiveParams, SignInProps, SignInRedirectOptions, SignOut, SignUpProps, SignUpRedirectOptions, UnsubscribeCallback, UserButtonProps, UserProfileProps, UserResource } from '@clerk/types';
