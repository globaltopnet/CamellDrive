...
import { ComponentPropsWithRef, ComponentType, ElementType, ReactElement, ReactNode, RefAttributes } from 'react';
...
export interface CodeFieldOverridableComponent {
    <C extends ElementType>(props: {
        InputComponent: C;
    } & OmitStyle<ComponentPropsWithRef<C>> & BaseProps): ReactElement;
