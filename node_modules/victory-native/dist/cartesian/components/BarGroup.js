...
function BarGroup({ betweenGroupPadding = 0.25, withinGroupPadding = 0.25, chartBounds, roundedCorners, children, onBarSizeChange, }) {
    ...
    const { paths, barWidth, groupWidth, gapWidth } = (0, useBarGroupPaths_1.useBarGroupPaths)(bars.map((bar) => bar.points), chartBounds, betweenGroupPadding, withinGroupPadding, roundedCorners);
