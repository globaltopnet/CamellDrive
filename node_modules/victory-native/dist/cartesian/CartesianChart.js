...
function CartesianChart({ data, xKey, yKeys, padding, domainPadding, children, renderOutside, axisOptions, domain, chartPressState, onChartBoundsChange, gestureLongPressDelay = 100, }) {
    ...
    const { xScale, yScale, chartBounds, isNumericalData, _tData } = React.useMemo(() => {
        const _a = (0, transformInputData_1.transformInputData)({
            ...
            axisOptions: axisOptions
                ? Object.assign({}, CartesianAxis_1.CartesianAxis.defaultProps, axisOptions)
                : undefined,
            outputWindow: {
