...
const createRoundedRectPath = (x, y, width, height, corners) => {
    /**
    ...
    return `
    M ${x + topLeft}, ${y} H ${x + width - topRight} Q ${x + width}, ${y}, ${x + width}, ${y + topRight} V ${y + height - bottomRight} Q ${x + width}, ${y + height}, ${x + width - bottomRight}, ${y + height} H ${x + bottomLeft} Q ${x}, ${y + height}, ${x}, ${y + height - bottomLeft} V ${y + topLeft} Q ${x}, ${y}, ${x + topLeft}, ${y} Z
  `.trim();
};
