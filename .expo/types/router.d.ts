...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/_sitemap` | `/interfaces/crypto` | `/login/help` | `/login/login` | `/main/CustomHeader` | `/main/DrawerMenu` | `/main/SearchBar` | `/main/SubCustomHeader` | `/main/SubTabScreenHeader` | `/main/TabScreenHeader` | `/main/Tabs` | `/myvenv/lib/python3.12/site-packages/urllib3/contrib/emscripten/emscripten_fetch_worker` | `/myvenv/lib/python3.12/site-packages/werkzeug/debug/shared/debugger` | `/navigation/navigation` | `/screens/BinScreen` | `/screens/ChartScreen` | `/screens/FavoriteScreen` | `/screens/FileScreen` | `/screens/HelpScreen` | `/screens/HomeScreen` | `/screens/MediaScreen` | `/screens/PlusMenu` | `/screens/ProfileModal` | `/screens/SettingScreen` | `/screens/ShareScreen` | `/screens/UpgradePlanScreen` | `/screens/WalletScreen` | `/theme/color`;
